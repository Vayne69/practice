...
/**
 * @author : Yang Jian
 * @date : 2019/9/19 19:21
 */
@Component
public class MyCustomHystrixFilter extends AbstractGatewayFilterFactory<MyCustomHystrixFilter.Config> {
    private static final String FORWARD_KEY = "forward";
    private static final String NAME = "CustomHystrix";
    private static final int TIMEOUT_MS = 1000;
    private final ObjectProvider<DispatcherHandler> dispatcherHandlers;
    private volatile DispatcherHandler dispatcherHandler;
    private boolean processConfig = false;

    public MyCustomHystrixFilter(ObjectProvider<DispatcherHandler> dispatcherHandlers) {
        super(Config.class);
        this.dispatcherHandlers = dispatcherHandlers;
    }

    private DispatcherHandler getDispatcherHandler() {
        if (dispatcherHandler == null) {
            dispatcherHandler = dispatcherHandlers.getIfAvailable();
        }
    ...
    private class CustomHystrixCommand extends HystrixObservableCommand<Void> {
        ...
        private CustomHystrixCommand(URI fallbackUri,
